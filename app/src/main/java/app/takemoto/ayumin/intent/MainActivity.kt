package app.takemoto.ayumin.intent
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        browzerButton.setOnClickListener {
            val browzerIntent = Intent(Intent.ACTION_VIEW)
            browzerIntent.data = Uri.parse("https://life-is-tech.com/")
            if(browzerIntent.resolveActivity(packageManager) != null){
                startActivity((browzerIntent))
            }
        }
